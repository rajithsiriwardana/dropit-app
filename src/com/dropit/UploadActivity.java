...
public class UploadActivity extends Activity {
	...
	private void init(){
		...
		downloadBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent in = new Intent(UploadActivity.this,DownloadActivity.class);
				startActivity(in);
			}
		});
	}
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        case 123:
            if (resultCode == RESULT_OK) {
                ...
                fileIconImg.setImageDrawable(getResources().getDrawable(R.drawable.file));
	...
	class uploadTask extends AsyncTask<Void, Void, Void>{
		...
		protected void onPreExecute() {
			fileIconImg.setImageDrawable(getResources().getDrawable(R.drawable.loading));
		...
		protected void onPostExecute(Void result) {
			...
			fileIconImg.setImageDrawable(getResources().getDrawable(R.drawable.upload_ok));
		}
